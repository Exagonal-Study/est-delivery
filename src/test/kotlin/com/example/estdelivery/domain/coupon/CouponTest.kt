...
class CouponTest : FreeSpec({
    val 나눠준_비율_할인_쿠폰 = RateDiscountCoupon(10, "10% 할인 쿠폰", "10% 할인 쿠폰 설명", CouponType.IS_HAND_OUT)
    val 게시된_고정_할인_쿠폰 = FixDiscountCoupon(1000, "1000원 할인 쿠폰", "1000원 할인 쿠폰 설명", CouponType.IS_PUBLISHED)
